      ...
      <div className="mt-10 pb-44">
        ...
        <div className="bg-product bg-top bg-no-repeat bg-cover">
          <div className="container sm:px-10 flex flex-col lg:flex-row gap-x-32 gap-y-10 justify-between">
            <div className=" basis-[45%] mt-32">
              ...
              <div className="my-4">
                ...
                <div className="flex gap-5 my-3">
                  ...
                  />
                  <p className="text-lg font-medium">
                    Unlimited branches can be created
                  </p>
                </div>
                <div className="flex gap-5 my-3">
                  <Image
                  ...
                  />
                  <p className="text-lg font-medium">
                    Proper communication channel to all customer
                  </p>
                </div>
                <div className="flex gap-5">
                  <Image
            ...
            >
              <Image
                className="ml-[auto] mr-[auto] mt-[150px]"
        ...
        <div className="bg-product bg-top bg-no-repeat bg-cover">
          <div className="container sm:px-10 flex flex-col lg:flex-row-reverse gap-x-32 gap-y-10">
            <div className=" basis-[45%] mt-32">
              ...
              <p className="my-5 text-lg">
                Utility payment apps to meet all basic needs
              </p>
              <div className="my-4">
                <div className="flex gap-5">
                  <Image
                ...
                <div className="flex gap-5 my-3">
                  ...
                  />
                  <p className="text-lg font-medium">
                    Electricity, cable, airtime and other utility payment
                  </p>
                </div>
                <div className="flex gap-5">
                  <Image
            ...
            >
              <Image
                className="ml-[auto] mr-[auto] mt-[200px]"
            ...
            <div className=" basis-[45%] mt-20">
              ...
              <div className="my-4">
                <div className="flex gap-5">
                  ...
                  />
                  <p className="text-lg font-medium">
                    Instant ID card for staff and students
                  </p>
                </div>
                <div className="flex gap-5 my-3">
                  <Image
